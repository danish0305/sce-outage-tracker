"""Step 1 - Discover PG&E's live outage data endpoint (same method used for SCE/LADWP)."""
import json, re, pathlib, traceback
from playwright.sync_api import sync_playwright

URL = "https://pgealerts.alerts.pge.com/outage-map/"
ZIPS = ["94102", "95814", "93701"]   # San Francisco, Sacramento, Fresno
...
NOISE = re.compile(r"(google|gtm|gtag|analytics|doubleclick|facebook|adobe|demdex|omtrdc|"
    r"quantum|optimizely|hotjar|newrelic|nr-data|cookielaw|onetrust|cookiebot|tealium|"
...
INTEREST = re.compile(r"(kubra|stormcenter|currentstate|arcgis|esri|featureserver|mapserver|"
    r"outage|thematic|cluster|/api/|geojson|query\?|/v\d+/|circuit|incident|/data/|summary|feed)", re.I)
...
def main():
    with sync_playwright() as p:
        ...
        for label in ["Reject All","Decline","Necessary only","Accept All","Accept","I Agree","OK","Got it","Continue"]:
            try:
