"""Step 1 - Discover Burbank Water & Power outage endpoint (self-hosted 'POP' portal)."""
import json, re, pathlib, traceback
from playwright.sync_api import sync_playwright

URL = "https://pop.burbankwaterandpower.com/POP/pages/outage-map.html?ServiceType=Electric"
ZIPS = ["91502", "91505"]   # Burbank
...
INTEREST = re.compile(r"(kubra|arcgis|esri|featureserver|outage|/api/|geojson|query|\.php|"
    r"\.json|\.ashx|\.asmx|\.svc|xml|circuit|incident|data|marker|kml|rest)", re.I)
...
def main():
    with sync_playwright() as p:
        ...
        for s in ["canvas",".leaflet-container",".gm-style","#map","div[class*='map' i]"]:
            try:
